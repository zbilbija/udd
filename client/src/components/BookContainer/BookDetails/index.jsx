            ...
            <div>
                <Form>
                    <FormGroup>
                        ...
                        <Input type="file" name="file" id="bookFile" onChange={this.sendFileForMetadata} accept=".pdf" disabled={this.props.disableInputs}/>
                    ...
                    {this.state.update &&
                        ...
                        <FormGroup>
                            ...
                            <Input value={this.state.book.author} type="text" id="author" name="author" onChange={this.updateState} disabled={this.props.disableInputs}/>
                        </FormGroup>
                        <FormGroup>
                        ...
                        <FormGroup>
                            ...
                            <Input  type="select" id="language" name="language" onChange={this.updateLanguage} disabled={this.props.disableInputs}>
                        ...
                        <FormGroup>
                            ...
                            <Input value={this.state.book.publicationYear && this.state.book.publicationYear} type="number" name="publicationYear" id="publicationYear"
                             onChange={this.updateState} disabled={this.props.disableInputs}/>
                        </FormGroup>
                        <FormGroup>
                            <Label for="category">Category</Label>
                            <Input type="select" id="category" name="category" onChange={this.updateCategory} disabled={this.props.disableInputs}>
                    ...
                    {
                        !this.props.disableInputs && <Button style={{marginBottom: "10px"}}color="success" onClick={this.sendChanges}>Submit</Button>
                    }
                    <DownloadButton style={{marginTop: "10px"}}book={this.state.book} />
                </Form>
            </div>
        )
    }
